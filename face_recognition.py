...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl = Label(bg_lbl,text="Face Recognation",font=("times now roman",35,"bold"),fg="black")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                conn=mysql.connector.connect(host="localhost",username="root",password="am@@n_MYSQL1",database="facerecognizer1")
